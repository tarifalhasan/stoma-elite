const FixedProsthetics = () => {
  const FixedProstheticsData = [
    {
  ...
  return (
    <div className=" container flex  flex-col lg:flex-row justify-between">
      <div className=" lg:min-h-[632px] basis-full lg:basis-[40%] bg-primary space-y-5 xl:space-y-7 p-6 md:p-10">
        <h2 className=" text-4xl font-normal text-white">Ptotetică fixă</h2>
      </div>
      <div
      ...
      >
        <ul className=" space-y-6">
          {FixedProstheticsData.map((data, index) => (
            <li
              key={data.name}
...
export default FixedProsthetics;
